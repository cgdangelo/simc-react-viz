...
const PlayerPanel = ({classes, player, confidence}) => {
  const secondaryHeadingMetrics = []

  player.collected_data.dps && secondaryHeadingMetrics.push(
    <Chip
      key={0}
      label='DPS'
  ...
  player.collected_data.prioritydps && secondaryHeadingMetrics.push(
    <Chip
      key={1}
      label='Boss DPS'
      value={numberFormat(player.collected_data.dps.mean)}
  ...
  player.collected_data.dtps && secondaryHeadingMetrics.push(
    <Chip
      key={2}
      label='DTPS'
  ...
  player.collected_data.hps && secondaryHeadingMetrics.push(
    <Chip
      key={3}
      label='HPS'
  ...
  player.collected_data.aps && secondaryHeadingMetrics.push(
    <Chip
      key={4}
      label='APS'
